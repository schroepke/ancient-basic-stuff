...
640 print i;tab(7);
650 for j=1 to c
660 if a(i,j)=-1 then goto 700
670 if a(i,j)=0 then goto 720
680 print "* ";
690 goto 710
700 print "P ";
710 next j
...
730 next i
740 print
750 if f=0 then goto 770
760 return
770 REM GET CHOMPS FOR EACH PLAYER IN TURN
780 i1=i1+1
790 p1=i1-int(i1/p)*p
800 if p1<>0 then goto 820
810 p1=p
820 print "PLAYER ";p1
830 print "COORDINATES OF CHOMP (ROW,COLUMN)";
840 input r1,c1
850 if r1<1 then goto 920
860 if r1>r then goto 920
870 if c1<1 then goto 920
880 if c1>c then goto 920
890 if a(r1,c1)=0 then goto 920
900 if a(r1,c1)=-1 then goto 1010
910 goto 940
